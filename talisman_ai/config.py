...
MINER_ENQUEUE_TIMEOUT_SECONDS = float(os.getenv("MINER_ENQUEUE_TIMEOUT_SECONDS", "5.0"))
MINER_HOST_LLM_MAX_CONCURRENCY = int(os.getenv("MINER_HOST_LLM_MAX_CONCURRENCY", "8"))
MINER_HOST_LLM_SLOT_TTL_SECONDS = float(os.getenv("MINER_HOST_LLM_SLOT_TTL_SECONDS", "90"))
MINER_HOST_LLM_SLOT_HEARTBEAT_SECONDS = float(os.getenv("MINER_HOST_LLM_SLOT_HEARTBEAT_SECONDS", "10"))
MINER_HOST_LLM_WAIT_POLL_INTERVAL_SECONDS = float(os.getenv("MINER_HOST_LLM_WAIT_POLL_INTERVAL_SECONDS", "0.2"))
MINER_HOST_LLM_WAIT_LOG_INTERVAL_SECONDS = float(os.getenv("MINER_HOST_LLM_WAIT_LOG_INTERVAL_SECONDS", "15"))
...
MINER_CACHE_WAIT_LOG_INTERVAL_SECONDS = float(os.getenv("MINER_CACHE_WAIT_LOG_INTERVAL_SECONDS", "15"))
MINER_CACHE_MAX_STALE_WAIT_SECONDS = float(os.getenv("MINER_CACHE_MAX_STALE_WAIT_SECONDS", "300"))
